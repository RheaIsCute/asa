  ...
  return (
    <main className="tx-page">
      ...
      <section className="tx-shell">
        ...
        {!txid && <div className="tx-benefits" aria-label="Receipt information">
          <div><span>01 / CONFIRMATIONS</span><p>See where it stands</p><small>Confirmation progress refreshes while your transfer settles.</small></div>
          <div><span>02 / TRANSFER DETAILS</span><p>Follow the transaction</p><small>Inspect addresses, network fees, and on-chain timestamps.</small></div>
          <div><span>03 / PUBLIC RECEIPT</span><p>Keep everyone in the loop</p><small>Share a direct receipt link without connecting your wallet.</small></div>
        </div>}
        <p className="tx-foot tx-in tx-d4">
          Generated by ASARII · Chain data from BlockCypher{price ? ' · Price from CoinGecko' : ''} · No keys, no custody.
        </p>
      </section>
