  ...
  },
  {
    ...
    content: `
      <div class="hud-grid" style="gap: 15px;">
        <div class="social-flip-card" onclick="window.handleSocialClick(this, 'https://www.instagram.com/hataeruu/')">
          <div class="flip-inner">
            <div class="flip-front">
              <div style="width: 64px; height: 64px; fill: var(--text-main); margin-bottom: 12px; opacity: 0.9;">
              ...
              <div class="hud-label">Click to preview</div>
            </div>
            <div class="flip-back" style="background-image: url('/insta-preview.png');">
               <div class="hud-label" style="background: rgba(0,0,0,0.6); padding: 6px 12px; border-radius: 4px; backdrop-filter: blur(4px);">Click to open</div>
            </div>
          </div>
        </div>

        <div class="social-flip-card" onclick="window.handleSocialClick(this, 'https://discord.com/users/1408523273548988456')">
          <div class="flip-inner">
            <div class="flip-front">
              <div style="width: 64px; height: 64px; fill: var(--accent); margin-bottom: 12px;">
            ...
            <div class="flip-back" style="background-image: url('/discord-preview.png');">
               <div class="hud-label" style="background: rgba(0,0,0,0.6); padding: 6px 12px; border-radius: 4px; backdrop-filter: blur(4px);">Click to open</div>
            </div>
          </div>
        </div>
