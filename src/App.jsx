  ...
  },
  {
    ...
    content: `
      <div style="display: flex; flex-direction: column; gap: 15px; height: 100%;">
        ...
        <a href="https://discord.com/users/1408523273548988456" target="_blank" class="hud-block social-link" style="flex: 1; flex-direction:column; justify-content:center; align-items:center; gap: 8px; text-decoration: none;">
