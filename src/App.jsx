...
const SECTIONS_DATA = [
  ...
  },
  {
    ...
    lookOffset: [0, 0, 0],
    content: `
      <div class="hud-grid" style="gap: 15px; height: 100%;">
        <div class="hud-block social-link" onclick="window.handleSocialClick('https://www.instagram.com/hataeruu/')" style="flex: 1; flex-direction:column; justify-content:center; align-items:center; gap: 8px;">
           <div style="width: 64px; height: 64px; fill: var(--text-main); opacity: 0.9;">
        ...
        <div class="hud-block social-link" onclick="window.handleSocialClick('https://discord.com/users/1408523273548988456')" style="flex: 1; flex-direction:column; justify-content:center; align-items:center; gap: 8px;">
           <div style="width: 64px; height: 64px; fill: var(--accent);">
